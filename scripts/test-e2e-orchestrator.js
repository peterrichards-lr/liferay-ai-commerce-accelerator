...
const MICROSERVICE_DIR = path.join(__dirname, '../client-extensions/ai-commerce-accelerator-microservice');
...
async function runPlaywright() {
  ...
  return new Promise((resolve) => {
    const pw = spawn('npx', ['playwright', 'test', '--config=playwright-e2e.config.js'], {
      stdio: 'inherit',
      shell: true
    });
