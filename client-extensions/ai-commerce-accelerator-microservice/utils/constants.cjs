...
const QUEUE_CONFIG = {
  DEFAULT_CONCURRENCY: num('QUEUE_DEFAULT_CONCURRENCY', 2, ABS_MIN.QUEUE_CONCURRENCY),
  ...
  CLEANUP_INTERVAL: num('QUEUE_CLEANUP_INTERVAL', 300000, ABS_MIN.QUEUE_CLEANUP_INTERVAL),
...
const ENV = {
  ...
  LIFERAY_OAUTH_CLIENT_ID: str('LIFERAY_OAUTH_CLIENT_ID', 'id-f075bd58-1ab9-595d-ede3-34b86b79233'),
  ...
  WS_HEARTBEAT_MS: num('WS_HEARTBEAT_INTERVAL_MS', 30000, ABS_MIN.WS_HEARTBEAT_INTERVAL_MS),
  WS_RETRY_INTERVAL_MS: num('WS_RETRY_INTERVAL_MS', 500, ABS_MIN.WS_RETRY_INTERVAL_MS),
  ...
  OBJECT_STORAGE_SIGNED_URL_TTL_SEC: num('OBJECT_STORAGE_SIGNED_URL_TTL_SEC', 900, 60), // 15 minutes
  OBJECT_STORAGE_SIDECAR_ENDPOINT: str('OBJECT_STORAGE_SIDECAR_ENDPOINT', 'http://127.0.0.1:1106'),
};
