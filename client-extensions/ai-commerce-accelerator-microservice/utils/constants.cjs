...
const ERC_PREFIX = Object.freeze({
  ...
  BATCH_DELETION: `${APP_PREFIX}DEL-BATCH`,
  ERROR: `${APP_PREFIX}ERR`,
  IMAGE: `${APP_PREFIX}IMG`,
  INVENTORY_BATCH: `${APP_PREFIX}INV-BATCH`,
  INVENTORY: `${APP_PREFIX}INV`,
  ...
  PRICEENTRY_BATCH: `${APP_PREFIX}PE-BATCH`,
  PRODUCT_BATCH: `${APP_PREFIX}PRD-BATCH`,
  PROMOTION_BATCH: `${APP_PREFIX}PROM-BATCH`,
  PRODUCT: `${APP_PREFIX}PRD`,
  SKU_BATCH: `${APP_PREFIX}SKU-BATCH`,
  SKU: `${APP_PREFIX}SKU`,
  ...
  WAREHOUSEITEM_BATCH: `${APP_PREFIX}WH-ITEM-BATCH`,
  WAREHOUSE: `${APP_PREFIX}WH`,
});
