...
const ENTITY_CONFIGS = [
  { id: 'ai-model-options', title: 'AI Model Options', configKey: AI_MODEL_OPTIONS_CONFIG_KEY },
];
...
export default function AiConfigPanel() {
  ...
  } = useObjectStorage({ keys: ENTITY_CONFIGS.map(c => c.configKey), defaults: ENTITY_CONFIGS.reduce((acc, { configKey }) => ({ ...acc, [configKey]: AI_MODEL_OPTIONS_DEFAULTS }), {}) });
      ...
      <div className="sheet-footer">
        ...
        <div className="btn-group-item">
          ...
          <ClayButton
            ...
            disabled={!dirty || saving || issues.some((m) => !m.startsWith('Warning:')) || hasErrors}
